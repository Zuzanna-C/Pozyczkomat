...
begin
  ...
  begin
    ...
    if (fieldName = 'id') then Continue;
      ...
      if fieldName = 'itemtype' then
      begin
        col.Title.Caption := 'Type';
        col.Width := 100;
      end
      else if fieldName = 'itemdescription' then
      begin
        col.Title.Caption := 'Item';
        col.Width := 200;
      end
      else if fieldName = 'amount' then
      begin
        col.Title.Caption := 'Amount';
        col.Width := 100;
      end
      else if fieldName = 'startdate' then
      begin
        col.Title.Caption := 'Start Date';
        col.Width := 100;
      end
      else if fieldName = 'duetdate' then
      begin
        col.Title.Caption := 'Due Date';
        col.Width := 100;
      end
      else if fieldName = 'returned' then
      begin
        col.Title.Caption := 'Returned';
        col.Width := 100;
      end
      else if fieldName = 'notes' then
      begin
        col.Title.Caption := 'Notes';
        col.Width := 200;
      end
      else
      begin
        col.Title.Caption := fieldName;
        col.Width := 100;
      end;
    end;
  end;
