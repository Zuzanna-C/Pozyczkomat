...
begin
  ...
  CBOwner.Items.Insert(0, 'Ja');
  CBOwner.Items.Objects[0] := TObject(-1);

  CBUser.Items.Insert(0, 'Ja');
...
begin
  ...
  case FTransactionMode of
    tmLent:
      begin
        CBOwner.ItemIndex := CBOwner.Items.IndexOf('Ja');
    ...
    tmBorrowed:
      begin
        CBUser.ItemIndex := CBUser.Items.IndexOf('Ja');
...
begin
  ...
  begin
    CBUser.Enabled := False;
    CBUser.ItemIndex := CBOwner.Items.IndexOf('Ja');
  end;
