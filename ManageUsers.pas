  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          SQL.Text :=
            'UPDATE Users SET Username = :u, Password = :p, Role = :r WHERE ID = :id';
      ...
      begin
        ...
        begin
          Close;
          SQL.Text :=
            'INSERT INTO Users (Username, Password, Role, Active) VALUES (:u, :p, :r, 1)';
          ParamByName('U').AsString := username;
    ...
    begin
      ...
      begin
        ...
        SQL.Text :=
          'UPDATE Entities SET UserId = :uid, ModId = :modid, Date = datetime(''now''), Active = 1 WHERE Id = :eid';
