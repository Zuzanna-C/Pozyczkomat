...
begin
  ...
  HighlightBorrowed := SameText(Root.ChildNodes['HighlightBorrowed']
    .Text, 'true');
...
begin
  ...
  begin
    ...
    ImageBorrowed.Picture.Bitmap.Canvas.FillRect(Rect(0, 0, ImageBorrowed.Width,
      ImageBorrowed.Height));
...
begin
  ...
  begin
    ...
    ImageLoans.Picture.Bitmap.Canvas.FillRect(Rect(0, 0, ImageLoans.Width,
      ImageLoans.Height));
    ImageLoans.Refresh;
  end;
end;
...
begin
  ...
  ImageBorrowed.Picture.Bitmap.SetSize(ImageBorrowed.Width,
    ImageBorrowed.Height);
  ImageBorrowed.Picture.Bitmap.Canvas.Brush.Color := BorrowedColor;
  ImageBorrowed.Picture.Bitmap.Canvas.FillRect(Rect(0, 0, ImageBorrowed.Width,
    ImageBorrowed.Height));
